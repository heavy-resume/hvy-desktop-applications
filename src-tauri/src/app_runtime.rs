...
fn build_menu(app: &AppHandle) -> tauri::Result<tauri::menu::Menu<tauri::Wry>> {
    ...
    let edit = SubmenuBuilder::with_id(app, "edit-menu", "Edit")
        ...
        .separator()
        .item(&MenuItemBuilder::new("Bold").id("bold").build(app)?)
        .item(&MenuItemBuilder::new("Italic").id("italic").build(app)?)
        .item(&MenuItemBuilder::new("Underline").id("underline").build(app)?)
