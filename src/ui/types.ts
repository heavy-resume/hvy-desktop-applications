...
export interface UiHandlers {
  ...
  discoverIntegrationWebMcpTools(integrationId: string, pageId: string): void;
  reviewIntegrationWebMcpTool(integrationId: string, pageId: string, toolIndex: number): void;
  cancelIntegrationWebMcpReview(): void;
  approveIntegrationWebMcpTool(scriptingEnabled: boolean, mcpExposed: boolean): void;
  setIntegrationWebMcpExposure(capabilityId: string, kind: 'scripting' | 'mcp', enabled: boolean): void;
  requestInvokeIntegrationWebMcpTool(capabilityId: string): void;
